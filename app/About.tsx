	...
	return (
		<div className=" font-work flex flex-col phone:gap-16 gap-8">
			<div className="flex flex-col phone:gap-4 bg-slate-100 p-8">
				...
				<p className="font-bold text-3xl lg:text-5xl phone:-mt-6 -mt-3 text-tedx">
					TEDx Event?
				</p>
				<div className="font-semibold text-slate-900 text-xs phone:text-sm lg:text-base mt-4 phone:mt-0">
					...
					<br className="phone:hidden " /> These events feature live
					speakers as well as recorded TED Talks, all organized
			...
			<div className="flex flex-col phone:gap-4 bg-slate-100 p-8">
				...
				<div className="font-semibold text-slate-900 text-xs phone:text-sm lg:text-base mt-4 phone:mt-0">
					...
					you to a multitude of ideas.{" "}
					<br className="phone:hidden " />{" "}
					<br className="phone:hidden " /> Keeping in mind the TED
					slogan of &apos;Ideas worth Spreading &apos;, TEDx PESU 2023
					gives you an opportunity to witness live TEDx talks, this
					time centered around the theme of The Indian Tapestry Of
					Thought delivered by the greatest of Indian minds. <br />{" "}
					<br /> Join us on the{" "}
