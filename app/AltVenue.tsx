function AltVenue() {
	return (
		<div className="h-screen bg-[url('/images/gjbc.jpeg')] bg-cover bg-no-repeat bg-center font-work relative text-white -mt-1">
			...
			<div className="w-full phone:w-fit flex flex-col items-center px-4 phone:px-0 justify-center phone:h-auto h-full phone:block phone:absolute phone:bottom-40 phone:right-20">
